...
<div class="sidenav-menu">
    ...
    <div data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a href="{{ route('pagePerpusPeminjaman') }}" class="side-nav-link">
                    <span class="menu-icon">
            ...
            <li class="side-nav-item">
                <a href="{{ route('pagePerpusPengembalian') }}" class="side-nav-link">
                    <span class="menu-icon">
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a href="{{ route('pageJurusan') }}" class="side-nav-link">
                    <span class="menu-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-door">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M14 12v.01" />
            ...
            <li class="side-nav-item">
                <a href="{{ route('pageMapel') }}" class="side-nav-link">
                    <span class="menu-icon">
