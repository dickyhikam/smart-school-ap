        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header border-bottom border-dashed d-flex justify-content-between align-items-center">
                    ...
                    <a class="btn btn-soft-primary btn-sm d-flex align-items-center gap-1" href="{{ route('pageFormPerpusPengarang') }}">
                        ...
                        <table class="table table-bordered table-hover table-striped align-middle" id="siswaTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $row['nama'] }}</td>
                                    <td>
                                        <button class="btn btn-warning btn-sm" data-bs-toggle="tooltip" title="Edit {{ $nama_menu }}" onclick="window.location.href='{{ route('pageFormEditPerpusPengarang', ['id' => $row['id']]) }}'">
