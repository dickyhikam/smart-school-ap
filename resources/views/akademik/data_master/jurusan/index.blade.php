        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header border-bottom border-dashed d-flex justify-content-between align-items-center">
                    ...
                    <a class="btn btn-soft-primary btn-sm d-flex align-items-center gap-1" href="{{ route('pageFormJurusan') }}">
                        ...
                        <table class="table table-bordered table-hover table-striped align-middle" id="siswaTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-warning btn-sm" data-bs-toggle="tooltip" title="Edit {{ $nama_menu }}" onclick="window.location.href='{{ route('pageFormEditJurusan', ['id' => $row['id']]) }}'">
                                        ...
                                        <button class="btn btn-danger btn-sm {{ $row['status']['value'] == '1' ? 'disabled' : '' }}" data-bs-toggle="tooltip" title="Hapus {{ $nama_menu }}" data-bs-toggle="modal" data-bs-target="#deleteModal" title="Hapus {{ $nama_menu }}" data-menu-id="{{ $row['id'] }}" data-menu-name="{{ $row['nama'] }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus jurusan <b id="deleteModalName"></b>?</p>
                </div>
                <div class="modal-footer">
                    <form action="{{ route('actionDeleteJurusan', ['id' => ':id']) }}" method="POST" id="deleteMenuForm">
                        @csrf
                        @method('DELETE')
